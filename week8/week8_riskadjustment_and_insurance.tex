...
\begin{frame}
  ...
  % BIG TITLE
  {\fontsize{30}{32}\selectfont\bfseries\textcolor{maroon}{Adverse selection, contract features, and risk-adjustment}}\\[-0.25cm]
...
%---------------------------------------------------------------------
\input{sections/risk_adjustment.tex}
%---------------------------------------------------------------------
...
%---------------------------------------------------------------------
\begin{frame}{Reminder from last class (no pooling equilibrium)}
  	\hypertarget{RS:nopooling}{}
    \begin{columns}[T]
  ...
  \hyperlink{creamskimming}{\beamerreturnbutton{Back}}

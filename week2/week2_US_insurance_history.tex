...
\begin{frame}
  ...
  % BIG TITLE
  {\fontsize{30}{32}\selectfont\bfseries\textcolor{maroon}{Health Insurance in the U.S.\\ {\large A bit of history}}}\\[-0.25cm]
...
%---------------------------------------------------------------------
\input{sections/US_insurance_history.tex}
\input{sections/micro_review.tex}
%---------------------------------------------------------------------
\begin{frame}{}
  \begin{center}
...
\begin{frame}{What we covered today}
  ...
  \begin{enumerate}
    \item History of U.S. health insurance
    \item Microeconomics review
  \end{enumerate}
\end{frame}
%---------------------------------------------------------------------
%---------------------------------------------------------------------
\begin{frame}{To next class}
  \begin{itemize}
      ...
      \begin{enumerate}
          ...
          \item If want to go further: check out suggested references
          \item \newbold{Problem set 1} has been posted: due on \newbold{Tuesday February 3rd before 9:30am}
      \end{enumerate}
      \vspace{3mm}

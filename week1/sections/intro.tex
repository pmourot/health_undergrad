...
\begin{frame}{About me}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Where are healthcare services \textit{produced} and \textit{consummed} in the U.S.? {\small \textcolor{maroon}{Dingel, Gottlieb, Lozinski, Mourot (2024)}}
...
\begin{frame}{When do we meet?}
    ...
    \begin{itemize}
        \item \newbold{Class}\\
        Twice a week: Tuesdays \& Thrusdays 9:30am-10:45am in 685-725 Comm Ave CAS 226.
        \vspace{3mm}

        \item \newbold{Office hours}\\
        XX 11am-12pm in person at 270 Bay State Rd, Room 549.
    \end{itemize}
\end{frame}
%---------------------------------------------------------------------
\begin{frame}{Format of the course}
    ...
    \begin{itemize}
        ...
        \item We will have \newbold{homeworks}, graded for completion
        \vspace{3mm}

        \item 3 \newbold{exams}
        \begin{itemize}
            \item Midterm 1: Thursday, XX
            \item Midterm 2: Thursday, XX
            \item Final: Tuesday, XX
        \end{itemize}
    \end{itemize}
\end{frame}
%---------------------------------------------------------------------
...
\begin{frame}{Expectations}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Check understanding of in-class worksheets after class
            \item Practice using practice problems
            \item Come to office hours to ask questions
        \end{itemize}
    \end{itemize}
    \vspace{3mm}

    \textbf{Important}: if you need special accomodation for exams, please let me know by XX.
\end{frame}
%---------------------------------------------------------------------
\begin{frame}{}

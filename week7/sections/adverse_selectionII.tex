...
\begin{frame}{How to draw indifference curves in the $(I_H, I_S)$ space?}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.44\textwidth}
            \centering
            \only<2>{\includegraphics[width=\textwidth]{./input/BHT_fig94.png}}
        \end{column}
    \end{columns}
...
\begin{frame}{The full insurance line}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.44\textwidth}
            \centering
            \only<2>{\includegraphics[width=\textwidth]{./input/BHT_fig95.png}}
        \end{column}
    \end{columns}
...
\begin{frame}{The zero-profit line}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.44\textwidth}
            \centering
            \only<2>{\includegraphics[width=\textwidth]{./input/BHT_fig96.png}}
        \end{column}
    \end{columns}
...
\begin{frame}{Different indifference curves}
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            Utility curve for robust consumers are \textbf{steeper} than for frail consumers. \textit{Why?}\\

...
\begin{frame}{Understanding health insurance plans}
    ...
    \end{itemize}
    $\implies$ Today's class should help you better nderstand these choices and your options.
    \vspace{3mm}
...
\begin{frame}{To next class}
    \begin{itemize}
        \item \newbold{TO DO}
        \begin{enumerate}
            \item \newbold{Problem set 2} due on XX
            \item \newbold{Mandatory reading}: RAND Breif [reading 1]\\

...
\textbf{Office:} SSW 545 &
& \textbf{Office:} SSW B03A\\

\textbf{Email:} \email{pmourot@bu.edu}&
& \textbf{Email:} \email{yjcsong@bu.edu} \\

\textbf{Office hours:} Thursdays 1:30-3:30 PM &
& \textbf{Office hours:} Wednesdays 3-5 PM
\end{tabularx}
...
\begin{itemize}
    ...
    You can either type up your answers or \textbf{clearly} handwrite them and scan them.
    Handwritten answers that are not legible to the TA or myself will not be graded.
...
\begin{itemize}
    \item Midterm 1: February 19, 9:30am -- 10:45 am (in class)
    \item Midterm 2: April 2, 9:30am -- 10:45 am (in class)
    \item Final: TBD
\end{itemize}
...
\section*{Course schedule (tentative)}
  ...
  \hline
  \textbf{Week} & \textbf{Date} & \textbf{Class} & \textbf{Readings} & \textbf{Problem sets} \\
  \hline
  
  Week 1 
  & Tu Jan 20 & Class 1 - Introduction &  &  \\
  & Th Jan 22 & Class 2 - Introduction to the US healthcare system &  &  \\
  
%  \hline
  Week 2
  & Tu Jan 27 & Class 3 - Introduction to the US healthcare system \& Reminders &  &  \\
  & Th Jan 29 & Class 4 - Demand for health &  &  \\
  
%  \hline
  Week 3
  & Tu Feb 3 & Class 5 - Demand for health insurance &  & PS1 due \\
  & Th Feb 5 & Class 6 - Understanding a health insurance plan &  &  \\
  
%  \hline
  Week 4
  & Tu Feb 10 & Class 7 - Moral hazard I & READING 1 &  \\
  & Th Feb 12 & Class 8 - Moral hazard II &  & PS2 due \\
  
%  \hline
  Week 5
  & Tu Feb 17 & \textit{No class (substitute Monday schedule)} &  &  \\
  & Th Feb 19 & \textbf{MIDTERM 1} &  &  \\
  
%  \hline
  Week 6
  & Tu Feb 24 & Class 9 - Imperfect information and adverse selection &  &  \\
  & Th Feb 26 & Class 10 - Empirical evidence on adverse selection &  &  \\
  
%  \hline
  Week 7
  & Tu Mar 3 & Class 11 - Imperfect information and adverse selection II &  &  \\
  & Th Mar 5 & Class 12 - Imperfect information and adverse selection II &  & PS3 due \\
  
  \hline
  \multicolumn{5}{c}{\textit{Spring Break}} \\
  \hline
  
  Week 8
  & Tu Mar 17 & Class 13 - Policy response under adverse selection & READING 2 &  \\
  & Th Mar 19 & Class 14 - What does health insurance do? &  &  \\
  
%  \hline
  Week 9
  & Tu Mar 24 & Class 15 - Public insurance today - The ACA &  & PS4 due \\
  & Th Mar 26 & Class 16 - Public insurance today - The uninsured & READING 3 &  \\
  
%  \hline
  Week 10
  & Tu Mar 31 & Review session &  &  \\
  & Th Apr 2 & \textbf{MIDTERM 2} &  &  \\
  
%  \hline
  Week 11
  & Tu Apr 7 & Class 17 - Hospitals &  &  \\
  & Th Apr 9 & Class 18 - Doctors and nurses & READING 4 &  \\
  
%  \hline
  Week 12
  & Tu Apr 14 & Class 19 - Provider payments I &  &  \\
  & Th Apr 16 & Class 20 - Provider payments II &  &  \\
  
%  \hline
  Week 13
  & Tu Apr 21 & Class 21 - Pharmaceutical: R\&D and drug pricing &  &  \\
  & Th Apr 23 & Class 22 - Antitrust &  & PS5 due \\
  
%  \hline
  Week 14
  & Tu Apr 28 & Class 23 - Geography of healthcare I & READING 5 &  \\
  & Th Apr 30 & Class 24 - Geography of healthcare II &  &  \\
  
  \hline
  \multicolumn{5}{c}{\textbf{FINAL}} \\
  \hline
